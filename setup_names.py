...
detail_names = [
    ...
    {
        "name": 'Панель поддержки материнской платы %s' % (model_name),
        "name_ua": 'Панель підтримки материнської плати %s' % (model_name),

        "description_small": f"Панель поддержки материнской платы к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Панель підтримки материнської плати до ноутбука {model_name}, оригинальна, {state_ua}",

        "keywords": "нижняя крышка базы, панель поддержки материнской платы, дно корпуса, днище корпуса",
        "keywords_ua": "нижня кришка бази, панель підтримки материнськох плати, дно корпуса, днище корпуса",
        "portal": "Части корпуса ноутбука",
    ...
    {
        "name": 'Сервисная крышка шлейфа %s (LVDS)' % (model_name),
        "name_ua": 'Сервісна кришка шлейфу %s (LVDS)' % (model_name),

        "description_small": f"Сервисная крышка шлейфа матрицы к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Сервісна кришка шлейфу матриці до нутбуку {model_name}, оригінальна, {state_ua}",
    ...
    {
        "name": 'Плата ИК-порта %s (IR-port)' % (model_name),
        "name_ua": 'Плата ІЧ-порта %s (IR-port)' % (model_name),

        "description_small": f"Дополнительная плата ИК-порта к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Додаткова плата ІЧ-порта до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "плата ИК-порта, плата инфракрасного порта, ик-порт, IR-port",
        "keywords_ua": "плата ІЧ-порта, плата інфрачервоного порту, ір-порт, IR-port",
        "portal": "Адаптеры и платы расширения портов",
    ...
    {
        "name": 'Плата кнопки включения WI-FI %s' % (model_name),
        "name_ua": 'Плата кнопки включення WI-FI %s' % (model_name),

        "description_small": f"Дополнительная плата кнопки включения WI-FI к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Додаткова плата кнопки включення WI-FI до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "WI-FI, плата WI-FI, кнопка WI-FI",
        "keywords_ua": "WI-FI, плата WI-FI, кнопка WI-FI",
        "portal": "Адаптеры и платы расширения портов",
    ...
    {
        "name": 'Направляющая матрицы, правая %s' % (model_name),
        "name_ua": 'Направляюча матриці, права %s' % (model_name),

        "description_small": f"Направляющая матрицы, правая к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Направляюча матриці, права до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "направляющие матрицы, матрица, направляющие к матрице, направляющие экрана, стойки, стойки матрицы, стойки экрана",
        "keywords_ua": "направляючі матриці, матрица, направляючі до матриці, направляючі екрану, стійки, стійки матриці, стійки екрану",
        "portal": "Части корпуса ноутбука",
        
        "description_perfect": "Направляющая матрицы ровная, не гнутая, в заводском состоянии.",
        "description_good": "Направляющая матрицы ровная, не гнутая, в заводском состоянии.",
        "description_fail": "Направляющая матрицы ровная, не гнутая, в заводском состоянии.",

        "description_perfect_ua": "Направляюча матриці рівна, не гнута, в заводському стані.",
        "description_good_ua": "Направляюча матриці рівна, не гнута, в заводському стані.",
        "description_fail_ua": "Направляюча матриці рівна, не гнута, в заводському стані.",
    ...
    {
        "name": 'Направляющая матрицы, левая %s' % (model_name),
        "name_ua": 'Направляюча матриці, ліва %s' % (model_name),

        "description_small": f"Направляющая матрицы, левая к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Направляюча матриці, ліва до ноутбука {model_name}, оригінальна, {state_ua}",
    ...
    {
        "name": 'Заглушка слота PCMCIA %s' % (model_name),
        "name_ua": 'Заглушка слоту PCMCIA %s' % (model_name),

        "description_small": f"Заглушка слота PCMCIA к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка слоту PCMCIA до ноутбука {model_name}, оригінальна, {state_ua}",
    ...
    {
        "name": 'Заглушка слота SD %s' % (model_name),
        "name_ua": 'Заглушка слоту SD %s' % (model_name),

        "description_small": f"Заглушка слота SD к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка слоту SD до ноутбука {model_name}, оригінальна, {state_ua}",
    ...
    {
        "name": 'Заглушка слота Memory Stick %s' % (model_name),
        "name_ua": 'Заглушка слоту Memory Stick %s' % (model_name),

        "description_small": f"Заглушка слота Memory Stick к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка слоту Memory Stick до ноутбука {model_name}, оригінальна, {state_ua}",
