...
color = model['color']
brand_compatibility = model['brand_compatibility']
housing_material = model['housing_material']
...
detail_names = [
    ...
    },
    {
        ...
        "name_ua": "Накладка на роз'єми %s" % (model_name),

        "description_small": f"Накладка на разъёмы к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Накладка на роз'єми до ноутбука {model_name}, оригинальна, {state_ua}",

        "keywords": "накладка, накладка на разъемы, накладка на разъёмы, накладка разъёмов, панель",
        "keywords_ua": "накладка, накладка на роз'єми, накладка роз'ємів, панель",
        "portal": "Части корпуса ноутбука",
        
        "description_perfect": "Все крепления целые. Без сколов, царапин, трещин.",
        "description_good": "Все крепления целые.",
        "description_fail": "Все крепления целые.",

        "description_perfect_ua": "Всі кріплення цілі. Без сколів, царапок, тріщин.",
    ...
    },
    {
        ...
        "name_ua": 'Сервісна кришка корпусу %s' % (model_name),
    ...
    },
    {
        ...
        "name_ua": 'Сервісна кришка батареї %s' % (model_name),

        "description_small": f"Сервисная крышка батареи к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Сервісна кришка батареї до нутбуку {model_name}, оригінальна, {state_ua}",

        "keywords": "сервисная крышка, крышка, заглушка, крышка батареи",
        "keywords_ua": "сервісна кришка, кришка, заглушка, кришка батареї",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "name_ua": 'Сервісна кришка HDD/SSD 1 %s' % (model_name),
        ...
        "description_perfect": "Внимание, в ноутбуке несколько сервисных крышек для HDD/SSD и они разные. Все крепления целые. Сервисная крышка вымыта и почищена.",
        "description_good": "Внимание, в ноутбуке несколько сервисных крышек для HDD/SSD и они разные. Все крепления целые. Сервисная крышка вымыта и почищена.",
        "description_fail": "Внимание, в ноутбуке несколько сервисных крышек для HDD/SSD и они разные. Все крепления целые. Сервисная крышка вымыта и почищена.",

        "description_perfect_ua": "Увага, в ноутбуці декілька сервісних кришок для HDD/SSD і вони різні. Всі кріплення цілі. Сервісна кришка вимита та почищена.",
        "description_good_ua": "Увага, в ноутбуці декілька сервісних кришок для HDD/SSD і вони різні. Всі кріплення цілі. Сервісна кришка вимита та почищена.",
        "description_fail_ua": "Увага, в ноутбуці декілька сервісних кришок для HDD/SSD і вони різні. Всі кріплення цілі. Сервісна кришка вимита та почищена.",
    ...
    },
    {
        ...
        "name_ua": 'Сервісна кришка HDD/SSD 2 %s' % (model_name),
    ...
    },
    {
        ...
        "name_ua": "Сервісна кришка пам'ять, ОЗУ, RAM %s" % (model_name),
    ...
    },
    {
        ...
        "name_ua": 'Сервісна кришка блютуз %s' % (model_name),

        "description_small": f"Сервисная крышка блютуз к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Сервісна кришка блютуз до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "сервисная крышка, сервисная крышка блютуз, крышка блютуз, заглушка блютуз",
        "keywords_ua": "сервісна кришка, сервісна кришка блютуз, кришка блютуз, заглушка блютуз",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "description_perfect": "Клавиатура вымыта, почищена. Клавиатура не тестировалась. Продается как есть.",
        "description_good": "Клавиатура вымыта, почищена. Клавиатура не тестировалась. Продается как есть.",
        "description_fail": "Клавиатура вымыта, почищена. Клавиатура не тестировалась. Продается как есть.",

        "description_perfect_ua": "Клавіатура вимита, почищена. Клавіатура не тестувалась. Продається як є.",
        "description_good_ua": "Клавіатура вимита, почищена. Клавіатура не тестувалась. Продається як є.",
        "description_fail_ua": "Клавіатура вимита, почищена. Клавіатура не тестувалась. Продається як є.",
...

    {
        ...
        "Название_Характеристики_4":"Класс качества",
        "Название_Характеристики_5":"Назначение",
        "Название_Характеристики_6":"Платформа",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
    ...
    },
    {
        ...
        "flaw_perfect": "При осмотре и тестировании недостатков не обнаружено.",
        "flaw_good": "При осмотре и тестировании недостатков не обнаружено.",
        "flaw_fail": "",

        "flaw_perfect_ua": "При огляді та тестуванні недоліків не виявлено.",
        ...
        "Название_Характеристики_3":"Состояние",
        "Название_Характеристики_4":"Класс качества",
        "Название_Характеристики_5":"Тип системы охлаждения",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
    ...
    },
    {
        ...
        "name_ua": 'Кулер, вентилятор для процесору %s (FAN)' % (model_name),

        "description_small": f"Кулер, вентилятор процессора, снятый с ноутбука {model_name}, оригинальный, {state}",
        "description_small_ua": f"Кулер, вентилятор процесору, знятий з ноутбука {model_name}, оригінальний, {state_ua}",
    ...
    },
    {
        ...
        "name_ua": 'Кулер, вентилятор для відеокарти %s (FAN)' % (model_name),

        "description_small": f"Кулер, вентилятор видеокарты, снятый с ноутбука {model_name}, оригинальный, {state}",
        "description_small_ua": f"Кулер, вентилятор відеокарти, знятий з ноутбука {model_name}, оригінальний, {state_ua}",
    ...
    },
    {
        ...
        "Название_Характеристики_4":"Класс качества",
        "Название_Характеристики_5":"Назначение",
        "Название_Характеристики_6":"Система охлаждения",
        "Название_Характеристики_7":"Количество кулеров",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
        "Значение_Характеристики_5":"Для корпуса",
    ...
    },
    {
        ...
        "name_ua": 'Система охолодження, термотрубка %s для відеокарти' % (model_name),
        ...
        "description_perfect": "Обратите внимание, термотрубка видеокарты и термотрубка процессора разные, проверьте перед покупкой что этот товар именно тот, который Вам нужен. Термотрубка проверена на теплопроводность - все в норме.",
        "description_good": "Обратите внимание, термотрубка видеокарты и термотрубка процессора разные, проверьте перед покупкой что этот товар именно тот, который Вам нужен. Термотрубка проверена на теплопроводность - все в норме.",
        "description_fail": "Обратите внимание, термотрубка видеокарты и термотрубка процессора разные, проверьте перед покупкой что этот товар именно тот, который Вам нужен. Термотрубка проверена на теплопроводность - все в норме.",

        "description_perfect_ua": "Зверніть увагу, термотрубка відеокарти та термотрубка процесору різні, перевірте перед покупкою що це саме той товар, що Вам потрібен. Термотрубка перевірена на теплопровідність - все в нормі.",
        "description_good_ua": "Зверніть увагу, термотрубка відеокарти та термотрубка процесору різні, перевірте перед покупкою що це саме той товар, що Вам потрібен. Термотрубка перевірена на теплопровідність - все в нормі.",
        "description_fail_ua": "Зверніть увагу, термотрубка відеокарти та термотрубка процесору різні, перевірте перед покупкою що це саме той товар, що Вам потрібен. Термотрубка перевірена на теплопровідність - все в нормі.",
    ...
    },
    {
        ...
        "name_ua": 'Система охолодження, термотрубка %s для процесора' % (model_name),
    ...
    },
    {
        ...
        "name_ua": 'Заглушка оптичного привіду ODD %s' % (model_name),

        "description_small": f"Заглушка оптического привода (ODD dummy) к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка оптичного привіду (ODD dummy) до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "Заглушка оптического привода, заглушка odd, odd",
        "keywords_ua": "Заглушка оптичного привіду, заглушка odd, odd",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "Название_Характеристики_4":"Класс качества",
        "Название_Характеристики_5":"Цвет",
        "Название_Характеристики_6":"Назначение",
        "Название_Характеристики_7":"Тип",
        "Название_Характеристики_8":"Размещение",
        "Название_Характеристики_9":"Интерфейсы",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
        "Значение_Характеристики_5":color,
        "Значение_Характеристики_6":purpose,
        "Значение_Характеристики_7":"DVD-RW",
    ...
    },
    {
        ...
        "name_ua": 'Плата USB 2 %s (юсб)' % (model_name),
    ...
    },
    {
        ...
        "name_ua": 'Плата, шлейф мультимедійні кнопки 2 %s (multimedia)' % (model_name),
    ...
    },
    {
        ...
        "name_ua": 'Плата, шлейф, енкодер %s' % (model_name),

        "description_small": f"Дополнительная плата энкодер к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Додаткова плата енкодер до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "плата, шлейф, кнопка, энкодер",
        "keywords_ua": "плата, шлейф, кнопка, енкодер",
        "portal": "Адаптеры и платы расширения портов",
        
        "description_perfect": "Шлейф не помятый.",
        "description_good": "Шлейф не помятый.",
        "description_fail": "Шлейф не помятый.",

        "description_perfect_ua": "Шлейф не пом'ятий.",
        "description_good_ua": "Шлейф не пом'ятий.",
        "description_fail_ua": "Шлейф не пом'ятий.",
    ...
    },
    {
        ...
        "name_ua": 'Плата індикації 2 %s' % (model_name),
        ...
        "description_perfect": "Внимание! В ноутбук установлены несколько плат индикации, перед покупкой убедитесь в том, что это именно та плата, которая Вам нужна.",
        "description_good": "Внимание! В ноутбук установлены несколько плат индикации, перед покупкой убедитесь в том, что это именно та плата, которая Вам нужна.",
        "description_fail": "Внимание! В ноутбук установлены несколько плат индикации, перед покупкой убедитесь в том, что это именно та плата, которая Вам нужна.",

        "description_perfect_ua": "Увага! В ноутбуці встановлено декілька плат індикації, перед покупкою переконайтесь в тому, що це саме та плата, яка Вам потрібна.",
        "description_good_ua": "Увага! В ноутбуці встановлено декілька плат індикації, перед покупкою переконайтесь в тому, що це саме та плата, яка Вам потрібна.",
        "description_fail_ua": "Увага! В ноутбуці встановлено декілька плат індикації, перед покупкою переконайтесь в тому, що це саме та плата, яка Вам потрібна.",
    ...
    },
    {
        ...
        "name_ua": 'Плата індикації 1 %s' % (model_name),
    ...
    },
    {
        ...
        "flaw_perfect_ua": "При огляді недоліків не виявлено.",
        ...
        "Название_Характеристики_3":"Состояние",
        "Название_Характеристики_4":"Класс качества",
        "Название_Характеристики_5":"Вид",
        "Название_Характеристики_6":"Форм-фактор",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
    ...
    },
    {
        ...
        "name_ua": 'Корзина, кріплення HDD/SSD 1 %s (caddy)' % (model_name),
        ...
        "description_perfect": "Обратите внимание, в ноутбук установлены несколько креплений и они разные.",
        "description_good": "Обратите внимание, в ноутбук установлены несколько креплений и они разные.",
        "description_fail": "Обратите внимание, в ноутбук установлены несколько креплений и они разные.",

        "description_perfect_ua": "Зверніть увагу, в ноутбук встановлені декілька кріплень і вони різні.",
        "description_good_ua": "Зверніть увагу, в ноутбук встановлені декілька кріплень і вони різні.",
    ...
    },
    {
        ...
        "name_ua": 'Корзина, кріплення HDD/SSD 2 %s (caddy)' % (model_name),
    ...
    },
    {
        ...
        "flaw_perfect": "При осмотре шлейфа недостатков не обнаружено.",
        "flaw_good": "При осмотре шлейфа недостатков не обнаружено.",
        "flaw_fail": "",

        "flaw_perfect_ua": "При огляді шлейфу недоліків не виявлено.",
        "flaw_good_ua": "При огляді шлейфу недоліків не виявлено.",
        "flaw_fail_ua": "",
    ...
    },
    {
        ...
        "name_ua": "Шлейф ODD/DVD %s" % (model_name),

        "description_small": f"ODD переходник SATA DVD и шлейф к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"ODD переходник SATA DVD та шлейф до ноутбуку {model_name}, оригінальний, {state_ua}",

        "keywords": "шлейф, переходник, адаптер, ODD переходник, DVD переходник",
        "keywords_ua": "шлейф, перехідник, адаптер, ODD перехідник, DVD перехідник",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
    ...
    },
    {
        ...
        "name_ua": "Шлейф SATA HDD/SSD %s" % (model_name),

        "description_small": f"ODD переходник SATA HDD/SSD и шлейф к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"ODD переходник SATA HDD/SSD та шлейф до ноутбуку {model_name}, оригінальний, {state_ua}",

        "keywords": "разьем, переходник, адаптер, ODD переходник, HDD/SSD переходник",
        "keywords_ua": "роз'єм, перехідник, адаптер, ODD перехідник, HDD/SSD перехідник",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
    ...
    },
    {
        ...
        "name_ua": "Роз'єм LAN, гніздо RJ45, кабель RJ45 %s" % (model_name),

        "description_small": f"Разъем RJ45 (LAN), гнездо, и кабель подключения к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Роз'єм RJ45 (LAN), гніздо та кабель підключення до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "разъем RJ45, гнездо RJ45, кабель RJ45",
        "keywords_ua": "роз'єм RJ45, гніздо RJ45, кабель RJ45",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
        
        "description_perfect": "",
        "description_good": "При осмотре недостатков не обнаружено.",
        "description_fail": "При осмотре недостатков не обнаружено.",

        "description_perfect_ua": "",
        "description_good_ua": "При огляді недоліків не виявлено.",
        "description_fail_ua": "При огляді недоліків не виявлено.",
    ...
    },
    {
        ...
        "name_ua": "Роз'єм, гніздо антенне, телевізійне %s" % (model_name),

        "description_small": f"Разъем, гнездо антенное, телевизионное к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Роз'єм, гніздо антенне, телевізійне до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "разъем, гнездо, кабель",
        "keywords_ua": "роз'єм, гніздо, кабель",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
    ...
    },
    {
        ...
        "name_ua": 'Модуль звукова карта %s' % (model_name),

        "description_small": f"Модуль звуковая карта к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Модуль звукова карта до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "модуль звуковая карта, модуль, звуковая карта, звук",
        "keywords_ua": "модуль звукова карта, модуль, звукова карта, звук",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": 'Модуль ТБ-тюнер %s (TV-тюнер)' % (model_name),

        "description_small": f"Модуль ТВ-тюнер к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Модуль ТБ-тюнер до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "модуль тв-тюнер, модуль, тв-тюнер, TV-тюнер",
        "keywords_ua": "модуль тб-тюнер, модуль, тб-тюнер, TV-тюнер",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": "Ssd Intel Turbo Memory Flesh пам'ять %s (TV-тюнер)" % (model_name),

        "description_small": f"Intel Turbo Memory Flesh память к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Intel Turbo Memory Flesh пам'ять до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "ssd, flash, flesh память",
        "keywords_ua": "ssd, flash, flesh пам'ять",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": 'Фільтр охолодження ноутбука %s (WEB-camera)' % (model_name),

        "description_small": f"Фильтр охлаждения к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Фільтр охолодження до ноутбука {model_name}, оригінальний, {state_ua}",
    ...
    },
    {
        ...
        "name_ua": 'Шлейф інвертора %s (inverter)' % (model_name),

        "description_small": f"Шлейф подключения инвертера к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Шлейф підключення інвертора до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "шлейф инвертера, шлейф, инвертор, инвертер",
        "keywords_ua": "шлейф інвертора, шлейф, інвертор, інвертер",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
    ...
    },
    {
        ...
        "keywords": "инвертор матрицы, инвертор, инвертор дисплея, инвертор екрана",
        "keywords_ua": "інвертор матриці, інвертор, інвертор дисплея, інвертор екрану",
        "portal": "Шлейфы и разъемы для ноутбуков, компьютеров, планшетов",
    ...
    },
    {
        ...
        "flaw_perfect_ua": "Під час огляду недоліків не виявлено.",
        "flaw_good_ua": "Під час огляду недоліків не виявлено.",
        "flaw_fail_ua": "",
    ...
    },
    {
        ...
        "Название_Характеристики_5":"Цвет",
        "Название_Характеристики_6":"Совместимость с брендом",
        "Название_Характеристики_7":"Назначение",
        "Название_Характеристики_8":"Тип аккумулятора",
        "Значение_Характеристики_1":vendor,
        "Значение_Характеристики_2":manufacturer_country,
        "Значение_Характеристики_3":state,
        "Значение_Характеристики_4":quality_class,
    ...
    },
    {
        ...
        "name_ua": 'Плата HDD/SSD %s' % (model_name),

        "description_small": f"Плата HDD/SSD к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Плата HDD/SSD до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "дополнительная плата, плата HDD/SSD, плата HDD, SSD плата",
        "keywords_ua": "додаткова плата, плата HDD/SSD, SSD плата, плата HDD",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": 'Плата сім-карти %s' % (model_name),

        "description_small": f"Плата сим-карты к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Плата сім-карти до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "плата, плата сим-карты, sim",
        "keywords_ua": "плата, плата сім-карти, sim",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": 'Накладка оптичного приводу %s' % (model_name),

        "description_small": f"Накладка оптического привода к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Накладка оптичного приводу до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "накладка, панель, накладка привода, панель привода, панель CD, накладка CD, панель DVD, накладка DVD",
        "keywords_ua": "накладка, панель, накладка приводу, панель приводу, панель CD, накладка CD, панель DVD, накладка DVD",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "name_ua": "Шлейф кнопки включення %s" % (model_name),

        "description_small": f"Шлейф к плате кнопки включения к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Шлейф до плати кнопки включення до ноутбуку {model_name}, оригінальний, {state_ua}",

        "keywords": "шлейф, кабель, провод, соединительный шлейф, панель кнопки включения",
        "keywords_ua": "шлейф, кабель, провід, з'єднуючий шлейф, панель кнопки включення",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": "Шлейф підключення батареї %s" % (model_name),

        "description_small": f"Шлейф подключения батареи от ноутбука {model_name}, оригинальный, {state}",
        "description_small_ua": f"Шлейф підключення батареї від ноутбуку {model_name}, оригінальний, {state_ua}",

        "keywords": "шлейф, кабель, провод, соединительный шлейф, батарея, шлейф батареи",
        "keywords_ua": "шлейф, кабель, провід, з'єднуючий шлейф, батарея, шлейф батареї",
        "portal": "Адаптеры и платы расширения портов",
    ...
    },
    {
        ...
        "name_ua": 'Заглушка кардрідера SD %s' % (model_name),

        "description_small": f"Заглушка кардридера SD к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка кардрідера SD до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "заглушка кардридера, заглушки, заглушка, SD",
        "keywords_ua": "заглушка кардрідера, заглушки, заглушка, SD",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "name_ua": 'Заглушка кардрідера PCMCIA %s' % (model_name),

        "description_small": f"Заглушка кардридера PCMCIA к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"Заглушка кардрідера PCMCIA до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "заглушка кардридера, заглушки, заглушка, PCMCIA",
        "keywords_ua": "заглушка кардрідера, заглушки, заглушка, PCMCIA",
        "portal": "Части корпуса ноутбука",
    ...
    },
    {
        ...
        "name_ua": 'Блок живлення %s оригінал' % (model_name),

        "description_small": f"Блок питания к ноутбуку {model_name}, оригинальный, {state}",
        "description_small_ua": f"Блок живлення до ноутбука {model_name}, оригінальний, {state_ua}",

        "keywords": "Блок питания, питание, розеточный блок питания",
        "keywords_ua": "Блок живлення, живлення, розетковий блок живлення",
        "portal": "Зарядные устройства для ноутбуков",
        
        "description_perfect": "Блок питания протестирован на нагрузке. Кабель питания 220В в комплекте.",
        "description_good": "Блок питания протестирован на нагрузке. Кабель питания 220В в комплекте.",
        "description_fail": "Блок питания протестирован на нагрузке. Кабель питания 220В в комплекте.",

        "description_perfect_ua": "Блок живлення протестований на нагрузці. Кабель живлення 220В в комплекті.",
        "description_good_ua": "Блок живлення протестований на нагрузці. Кабель живлення 220В в комплекті.",
        "description_fail_ua": "Блок живлення протестований на нагрузці. Кабель живлення 220В в комплекті.",
    ...
    },
    {
        ...
        "name_ua": 'ВЕБ-камера, шлейф инвертера, мікрофон %s (WEB-camera)' % (model_name),

        "description_small": f"ВЕБ-камера к ноутбуку {model_name}, оригинальная, {state}",
        "description_small_ua": f"ВЕБ-камера до ноутбука {model_name}, оригінальна, {state_ua}",

        "keywords": "ВЕБ-камера, WEB-camera, шлейф инвертера, шлейф, микрофон",
        "keywords_ua": "ВЕБ-камера, WEB-camera, шлейф інвертора, шлейф, микрофон",
        "portal": "Камеры для портативных пк",
        
        "description_perfect": "Камера в сборе. Шлейф не помятый. Контактные дорожки не повреждены.",
        "description_good": "Камера в сборе. Шлейф не помятый. Контактные дорожки не повреждены.",
        "description_fail": "Камера в сборе. Шлейф не помятый. Контактные дорожки не повреждены.",

        "description_perfect_ua": "Камера в зборі. Шлейф не пом'ятий. Контактні дорожки не пошкоджені.",
        "description_good_ua": "Камера в зборі. Шлейф не пом'ятий. Контактні дорожки не пошкоджені.",
        "description_fail_ua": "Камера в зборі. Шлейф не пом'ятий. Контактні дорожки не пошкоджені.",
...
# Адаптеры и платы расширения портов
# "Название_Характеристики_1":"Производитель",
# "Название_Характеристики_2":"Страна производитель",
# "Название_Характеристики_3":"Состояние",
# "Название_Характеристики_4":"Класс качества",
...
# Клавиатурные блоки для ноутбуков
# "Название_Характеристики_1":"Производитель",
# "Название_Характеристики_2":"Страна производитель",
# "Название_Характеристики_3":"Состояние",
# "Название_Характеристики_4":"Класс качества",
...
# "Значение_Характеристики_3":state,
# "Значение_Характеристики_4":quality_class,
# "Значение_Характеристики_5":"Активная Пассивная",
...
# "Значение_Характеристики_7":"DVD-RW",
# "Значение_Характеристики_8":"Внутреннее",
# "Значение_Характеристики_9":"IDE SATA",

# Звуковые запчасти для портативных пк
# "Название_Характеристики_1":"Производитель",
# "Название_Характеристики_2":"Страна производитель",
# "Название_Характеристики_3":"Состояние",
# "Название_Характеристики_4":"Класс качества",
...
# Матрицы для ноутбуков, планшетов и мониторов
# "Название_Характеристики_1":"Производитель",
# "Название_Характеристики_2":"Страна производитель",
# "Название_Характеристики_3":"Состояние",
# "Название_Характеристики_4":"Класс качества",
