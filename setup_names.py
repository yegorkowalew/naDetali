...
detail_names = [
    ...
    {
        "name": 'Сервисная крышка батареи %s (заглушка)' % (model_name),
        "name_ua": 'Сервісна кришка батареї %s (заглушка)' % (model_name),
    ...
    },
    {
        ...
        "description_perfect_ua": "Недостатков не обнаружено.",
        "description_good_ua": "Недостатков не обнаружено.",
        "description_fail_ua": "",

        "flaw_perfect": "Недоліків не виявлено.",
        "flaw_good": "Недоліків не виявлено.",
        "flaw_fail": "",
